  ...
  return (
    <Center>
      <VStack maxW='600px' textAlign='center'>
        ...
        <Text>{`Evals, or evaluations, are like school grades but for AI systems. We'd like anyone to easily access these test results, and contribute if they'd like.`}</Text>
        <Text>{`To grade someone or something well, it seems important that they can't cheat by peeking at the answers. To prevent AI systems from "cheating", OpenEval evals include a mix of public and private task instances.`}</Text>
