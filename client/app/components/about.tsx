...
export default function About() {
  return (
    <Center>
      ...
      <Text><b>Evals</b>, or evaluations, are like school grades but for AI models & agents. We'd like anyone to easily access the test results and try testing them for themselves.</Text>
