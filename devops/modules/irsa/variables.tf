...
variable "service_account_component" {
  description = "Kubernetes Service Account component type"
  type        = string
  default     = "controller"
}

variable "svc_image_pull_secrets" {
...
variable "helm_release_name" {
  description = "Helm release name anotation"
  type        = string
  default     = ""
}

variable "helm_release_namespace" {
  description = "Helm release name namespace"
  type        = string
  default     = ""
}
